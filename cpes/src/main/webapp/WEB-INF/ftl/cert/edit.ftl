					...
					<div class="widget-body fuelux">
						<div class="step-content">
							...
							<form class="form-horizontal" id="certForm" method="post" >
								<input type="hidden" name="id" value="${certImg.id }"/>
										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fname" name="name" style="border-left:none;" autocomplete="off" value="${certImg.name }">
												</div>
											</div>
										</div>
									</fieldset>
...
<script type="text/javascript">
	   ...
	   if ( fname == "" ) {
         ...
         $("#certForm").ajaxSubmit({
             ...
             success : function(r){
                 ...
                 if ( r.success ) {
                     layer.msg("资质信息增加成功", {time:2000, icon:1},function(){
	                     window.location.href = "#cert/index.htm";
                     });
                 } else {
	...
	var pagefunction = function() {
		drawBreadCrumb( ["权限管理", "<a href='#cert/index.htm'>资质管理</a>", "新增资质信息"] );
	};
	pagefunction();
</script>
