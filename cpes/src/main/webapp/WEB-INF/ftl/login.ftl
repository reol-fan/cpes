...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
							...
							<form action="index.html" id="login-form" class="smart-form client-form">
								...
								<fieldset>
									...
									<section>
										...
										<label class="input"> <i id="authicon" class="icon-append fa fa-exclamation-triangle"></i>
											<input type="text" id="authcode" name="authcode" placeholder="单击右面图标获取验证码">
											<b class="tooltip tooltip-top-right"><img id="authImg" /> </b> </label>
									</section>
								...
								<footer>
									<a id="submitBtn" class="btn btn-primary">
		...
		<script type="text/javascript">
			function codeLoad(){//发送/刷新验证码
				var url = "${APP_PATH}/system/user/verify.do?r1="+Math.floor(Math.random()*10);
					...
					$("#login-form").ajaxSubmit({    
						...
						success: function(r){
							...
							if(r.success){
								...
								layer.msg(r.error, {time:1000, icon:5, shift:6},function(){
									$("#authcode").val("");
									$("#authcode").focus();
								});
								codeLoad();
