										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="fname" name="name" style="border-left:none;" autocomplete="off" value="${role.name }">
												</div>
											</div>
										</div>
									</fieldset>
	   ...
	   if ( fname == "" ) {
         ...
         $("#roleForm").ajaxSubmit({
             ...
             success : function(r){
                 ...
                 if ( r.success ) {
                     layer.msg("角色信息修改成功", {time:2000, icon:1}, function(){
                    	 window.location.href = "#role/index.htm";
                     });
                 } else {
