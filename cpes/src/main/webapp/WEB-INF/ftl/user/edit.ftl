										...
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    ...
                                                    <input class="form-control" type="text" id="floginacct" name="loginacct" style="border-left:none;" autocomplete="off" value="${user.loginacct}">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-list-alt fa-fw"></i></span>
                                                    <span class="input-group-addon" style="color:red"><i class="glyphicon glyphicon-star"></i></span>
                                                    <input class="form-control" type="text" id="fname" name="name" style="border-left:none;" autocomplete="off" value="${user.name }">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-list-alt fa-fw"></i></span>
                                                    <span class="input-group-addon" style="color:red"><i class="glyphicon glyphicon-star"></i></span>
                                                    <input class="form-control" type="text" id="femail" name="email" style="border-left:none;" autocomplete="off" value="${user.email }">
												</div>
											</div>
										</div>
									</fieldset>
...
<script type="text/javascript">
	...
	function submitForm() {
	   ...
	   if ( !emailRE.test(femail) ) {
          layer.msg("邮箱格式错误，请重新输入", {time:2000, icon:5, shift:6}, function(){
              $("#femail").focus();
		      return;
          });
	   }
	...
	var pagefunction = function() {
		drawBreadCrumb( ["角色管理", "<a href='#user/index.htm'>用户管理</a>", "新增用户信息"] );
	};
	pagefunction();
</script>
