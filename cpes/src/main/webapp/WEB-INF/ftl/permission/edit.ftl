											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														...
														autocomplete="off" name="name" style="border-left: none;" value="${p.name}">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
													...
													<#else> <input class="form-control" type="text" id="furl"
														autocomplete="off" name="url" value="${p.url }"> </#if>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														...
														class="form-control" id="fseqno" name="seqno">
...
<div class="modal-footer" style="text-align: center;">
	<a href="javascript:;" class="btn btn-operation btn-success"
		onclick="submitForm()"><i class="fa fa-plus"></i>&nbsp;修改</a> <a
