	...
	<div class="row">
		<article class="col-sm-12 col-md-12 col-lg-12">
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-2"
				...
				<header>
					<h2>
						基本信息 （<i class="glyphicon glyphicon-star"></i>为必须输入项目）
					</h2>
				</header>
				<div>
...
.iconDiv div {
	cursor: pointer;
							...
							<form class="form-horizontal" id="permissionForm" method="post">
								...
								<input type="hidden" id="fpid" name="pid" value="${RequestParameters.pid}">
								<div class="step-pane active" id="step1">
											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-list-alt fa-fw"></i></span> <span
														class="input-group-addon" style="color: red"><i
														class="glyphicon glyphicon-star"></i></span> <input
														class="form-control" type="text" id="fname"
														autocomplete="off" name="name" style="border-left: none;">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-globe fa-fw"></i></span> <#if level == 1> <span
														class="input-group-addon" style="color: red"><i
														class="glyphicon glyphicon-star"></i></span> <input
														class="form-control" type="text" id="furl"
														autocomplete="off" name="url" style="border-left: none;">
													<#else> <input class="form-control" type="text" id="furl"
														autocomplete="off" name="url"> </#if>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i
														class="fa fa-list-ol fa-fw"></i></span> <select
														class="form-control" id="seqno" name="seqno">
									...
									<fieldset id="iconFs">
										<div class="form-group">
											...
											<div class="col-md-10">
												<div class="input-group">
													<span class="input-group-addon"><i id="iconI"
														class="fa fa-automobile fa-fw "></i></span> <input
														class="form-control" type="text" id="fa-icon-search"
														placeholder="搜索图标">
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-10" id="iconDiv">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-flash"></i> fa-flash <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-gears"></i> fa-gears <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-legal"></i> fa-legal <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-ruble"></i> fa-ruble <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-rupee"></i> fa-rupee <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-chain"></i> fa-chain <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
												...
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
													<i class="fa fa-paste"></i> fa-paste <span
														class="text-muted">(alias)</span>
												</div>
												<div class="col-xs-6 col-md-3 col-sm-4 demo-icon-font">
...
<div class="modal-footer" style="text-align: center;">
	<a href="javascript:;" class="btn btn-operation btn-success"
		onclick="submitForm()"><i class="fa fa-plus"></i>&nbsp;新增</a> <a
		href="javascript:;" class="btn btn-operation btn-danger"
		onclick="clearForm()"><i class="fa fa-refresh"></i>&nbsp;重置</a>
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		$.ajax({
			type : "POST",
			url : "${APP_PATH}/system/permission/save.do",
			data : {
				"name" : $("#fname").val(),
				"url" : $("#furl").val(),
				"icon" : $("[name='icon']").val(),
			...
			success : function(r){
				if(r.success){
					...
					layer.msg(r.error, {time:3000, icon:5, shift:6},function(){
