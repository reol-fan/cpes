...
<div class="wrapper"> 
  ...
  <!-- Header -->
	<div class="breadcrumb-sec donate-sec" style="background: url(assets/extra-images/bg-under-page.jpg) no-repeat; background-size:100% auto; min-height:250px;">
									...
									<div class="col-lg-12">
										<div class="donate-area">
											<ul class="nav nav-tabs" role="tablist">
												<li class="active" role="presentation"><a >实名认证信息</a></li>
											</ul>
												...
												<div id="messages" class="tab-pane active fade in" role="tabpanel">
													<div class="confirmation-area">
														<div class="donate-holder">
															...
															<strong>认证码认证成功！请您耐心等待人工审核，2个工作日内您将收到认证结果。</strong>
														</div>
													</div>
												</div>
